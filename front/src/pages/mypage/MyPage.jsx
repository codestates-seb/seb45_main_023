export default function MyPage() {
  ...
  return (
    <div className="flex flex-col items-center border-[1px] border-yellow-500 mt-[20px]">
      <div className="flex flex-col mt-2 border-b-1 border-black h-[25rem]">
      ...
      <div className="flex flex-col justify-between border-2 w-[50rem] h-[27.5rem] rounded-b-3xl mb-2 bg-white">
