...
export default function TopSidebar() {
  ...
  return (
    <div className="relative">
      <div className="flex flex-col w-[8rem] absolute top-20 left-[-8rem]">
        <Link
          to={RouteConst.mypage}
          className={`bg-lime-500 my-1 ${visibleLinks < 0 ? 'hidden' : ''} ${visibleLinks === 0 ? 'w-[10rem]' : ''}`}
        ...
        <Link
          ...
          className={`bg-amber-400 my-1 ${visibleLinks < 1 ? 'hidden' : ''} ${visibleLinks === 1 ? 'w-[10rem]' : ''}`}
        ...
        <Link
          ...
          className={`bg-cyan-700 my-1 ${visibleLinks < 2 ? 'hidden' : ''} ${visibleLinks === 2 ? 'w-[10rem]' : ''}`}
        ...
        <Link
          ...
          className={`bg-rose-500 my-1 ${visibleLinks < 3 ? 'hidden' : ''} ${visibleLinks === 3 ? 'w-[10rem]' : ''}`}
        ...
        <Link
          ...
          className={`bg-purple-600 my-1 ${visibleLinks < 4 ? 'hidden' : ''} ${visibleLinks === 4 ? 'w-[10rem]' : ''}`}
