  ...
  return (
    <div className="relative">
      <div className="flex flex-col justify-between w-[8rem] absolute top-20 left-0">
        <Link to={RouteConst.mypage} className={`bg-lime-500 ${route !== RouteConst.mypage ? 'hidden' : ''}`}>
        ...
        <Link to={RouteConst.myblog} className={`bg-amber-400 ${route !== RouteConst.myblog ? 'hidden' : ''}`}>
        ...
        <Link to={RouteConst.mybookmark} className={`bg-rose-500 ${route !== RouteConst.mybookmark ? 'hidden' : ''}`}>
